...
export const quizData = {
  ...
  1: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "A bull market refers to a period when stock prices are generally rising.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "A bull market is characterised by rising prices and investor optimism. A bear market is the opposite — prices are falling."
      },
      {
        id: 12,
        questionText: "What does 'market capitalisation' of a company represent?",
        questionType: "MCQ",
        options: [
          "The total value of the company's physical assets",
          "The total value of all outstanding shares",
          "The company's annual revenue",
          "The amount of debt the company holds"
        ],
        correctAnswer: "The total value of all outstanding shares",
        explanation: "Market capitalisation is calculated by multiplying the share price by the total number of outstanding shares."
      },
      {
        id: 13,
        questionText: "Which of the following is an example of a stock exchange?",
        questionType: "MCQ",
        options: [
          "PayPal",
          "Bloomberg",
        ...
        explanation: "NASDAQ is a major US stock exchange, alongside the NYSE. Bloomberg and Reuters are financial data providers, not exchanges."
      },
      {
        id: 14,
        questionText: "Preferred shareholders always have voting rights in a company.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "Preferred shareholders typically receive priority dividends but usually do not have voting rights. Voting rights generally belong to common shareholders."
      },
      {
        id: 15,
        questionText: "What is an IPO?",
        questionType: "MCQ",
        options: [
          "A type of government bond",
          "When a private company first offers shares to the public",
          "A fee charged by stock brokers",
          "A method of short selling"
        ],
        correctAnswer: "When a private company first offers shares to the public",
        explanation: "An Initial Public Offering (IPO) is the process by which a private company offers shares to the public for the first time, allowing it to raise capital."
      }
    ]
  },
  ...
  2: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "A market order guarantees execution but not the price. It fills at the best available price at that moment, which can differ from the last quoted price."
      },
      {
        id: 12,
        questionText: "What does 'going short' on a stock mean?",
        questionType: "MCQ",
        options: [
          "Buying a stock and holding it for a short period",
          "Selling borrowed shares with the intention of buying them back at a lower price",
          "Purchasing penny stocks",
          "Buying shares at market open"
        ],
        correctAnswer: "Selling borrowed shares with the intention of buying them back at a lower price",
        explanation: "Short selling involves borrowing shares and selling them, hoping the price drops so you can buy them back cheaper and return them, pocketing the difference."
      },
      {
        id: 13,
        questionText: "Which order type allows you to set the maximum price you are willing to pay for a stock?",
        questionType: "MCQ",
        options: [
          "Market order",
          "Stop order",
        ...
        explanation: "A limit order lets you set a specific price. Your order will only execute at that price or better, giving you control over entry and exit prices."
      },
      {
        id: 14,
        questionText: "The bid price is always higher than the ask price.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "The ask price is always higher than the bid price. The difference between them is called the spread, which is effectively the cost of executing a trade."
      },
      {
        id: 15,
        questionText: "What does 'liquidity' mean in the context of stock trading?",
        questionType: "MCQ",
        options: [
          ...
          "The volatility of a stock over 30 days"
        ],
        correctAnswer: "How easily a stock can be bought or sold without significantly affecting its price",
        explanation: "A liquid stock has high trading volume and many buyers and sellers, meaning you can enter and exit positions quickly without causing large price movements."
      }
    ]
  },
  ...
  3: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "Correlation measures how two assets move in relation to each other.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Correlation ranges from -1 to +1. A correlation of +1 means assets move together; -1 means they move in opposite directions. Low correlation between holdings improves diversification."
      },
      {
        id: 12,
        questionText: "Which of the following best describes 'systematic risk'?",
        questionType: "MCQ",
        options: [
          "Risk specific to one company or industry",
          "Risk that affects the entire market and cannot be diversified away",
          "Risk caused by poor management decisions",
          "Risk from currency fluctuations only"
        ],
        correctAnswer: "Risk that affects the entire market and cannot be diversified away",
        explanation: "Systematic risk (also called market risk) affects all investments, such as recessions or interest rate changes. It cannot be eliminated through diversification."
      },
      {
        id: 13,
        questionText: "What is a stop-loss order used for?",
        questionType: "MCQ",
        options: [
          "To lock in a profit when a stock rises",
          "To automatically sell a stock if it falls to a certain price",
          "To buy more shares when a price drops",
          "To prevent a stock being sold above a certain price"
        ],
        correctAnswer: "To automatically sell a stock if it falls to a certain price",
        explanation: "A stop-loss order triggers a sale when a stock falls to a specified price, limiting the investor's loss on a position."
      },
      {
        id: 14,
        questionText: "Holding stocks in only one sector provides good diversification.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "Concentrating in one sector exposes you to sector-specific risk. True diversification involves spreading investments across multiple sectors, asset classes, and geographies."
      },
      {
        id: 15,
        questionText: "Which of the following is an example of unsystematic risk?",
        questionType: "MCQ",
        options: [
          "A global recession",
          "A rise in interest rates",
          "A CEO of a company resigning suddenly",
          "A worldwide pandemic"
        ],
        correctAnswer: "A CEO of a company resigning suddenly",
        explanation: "Unsystematic risk is specific to a single company or industry. A CEO resignation affects that company only and can be reduced through diversification."
      }
    ]
  },
  ...
  4: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "A doji candlestick pattern suggests the market is in a strong trend.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "A doji forms when the open and close prices are nearly equal. It signals indecision in the market, often appearing at potential turning points."
      },
      {
        id: 12,
        questionText: "What does a 'resistance level' represent on a price chart?",
        questionType: "MCQ",
        options: [
          "A price level where buying pressure typically increases",
          "A price level where selling pressure tends to stop a price from rising",
          "The average price over the last 200 days",
          "The lowest recorded closing price in a year"
        ],
        correctAnswer: "A price level where selling pressure tends to stop a price from rising",
        explanation: "A resistance level is a price ceiling where selling pressure historically prevents the stock from rising further. If the price breaks through, it can signal a strong upward move."
      },
      {
        id: 13,
        questionText: "High trading volume during a price breakout generally indicates a stronger signal.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Volume confirms the strength of a price move. A breakout accompanied by high volume suggests strong conviction from buyers or sellers, making the move more reliable."
      },
      {
        id: 14,
        questionText: "What does an ascending triangle chart pattern typically suggest?",
        questionType: "MCQ",
        options: [
          "A potential bearish reversal",
          "A continuation of a downtrend",
          "A potential bullish breakout",
          "A period of market consolidation with no clear direction"
        ],
        correctAnswer: "A potential bullish breakout",
        explanation: "An ascending triangle forms with a flat resistance line and rising support. It typically signals that buyers are gaining strength and a bullish breakout may follow."
      },
      {
        id: 15,
        questionText: "Which of the following best describes a 'head and shoulders' pattern?",
        questionType: "MCQ",
        options: [
          "A bullish continuation pattern",
          "A bearish reversal pattern with three peaks",
          "A pattern showing equal highs and lows",
          "A breakout pattern following a period of consolidation"
        ],
        correctAnswer: "A bearish reversal pattern with three peaks",
        explanation: "The head and shoulders pattern has three peaks — a higher middle peak (head) flanked by two lower peaks (shoulders). It signals a potential reversal from an uptrend to a downtrend."
      }
    ]
  },
  ...
  5: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "A high price-to-earnings ratio always means a stock is overvalued.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "A high P/E ratio can reflect high growth expectations rather than overvaluation. Context matters — comparing P/E ratios within the same industry is more meaningful."
      },
      {
        id: 12,
        questionText: "What does 'earnings per share' (EPS) measure?",
        questionType: "MCQ",
        options: [
          ...
          "The company's debt divided by its share price"
        ],
        correctAnswer: "The company's net profit divided by the number of outstanding shares",
        explanation: "EPS shows how much profit a company generates for each share. A rising EPS indicates improving profitability and is a key indicator watched by investors."
      },
      {
        id: 13,
        questionText: "Which financial statement shows a company's revenues and expenses over a period of time?",
        questionType: "MCQ",
        options: [
          "Balance sheet",
          "Cash flow statement",
        ...
        explanation: "The income statement (also called the profit and loss statement) shows revenues, costs and expenses over a specific period, resulting in net profit or loss."
      },
      {
        id: 14,
        questionText: "Free cash flow is the cash a company generates after paying for operating expenses and capital expenditures.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Free cash flow (FCF) is what remains after a company covers its operating costs and capital spending. Strong FCF means the company has money left to pay dividends, buy back shares, or reinvest."
      },
      {
        id: 15,
        questionText: "What does a company's 'debt-to-equity ratio' indicate?",
        questionType: "MCQ",
        options: [
          "How profitable the company is relative to its equity",
          "The proportion of financing coming from debt versus shareholder equity",
          "The company's return on assets",
          "The amount of cash held per share"
        ],
        correctAnswer: "The proportion of financing coming from debt versus shareholder equity",
        explanation: "The debt-to-equity ratio compares total debt to shareholder equity. A high ratio means the company relies heavily on debt to finance operations, which can increase financial risk."
      }
    ]
  },
  ...
  6: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "The RSI is considered overbought when it rises above 70.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "An RSI above 70 suggests a stock may be overbought and due for a pullback. An RSI below 30 suggests it may be oversold and could be due for a bounce."
      },
      {
        id: 12,
        questionText: "What does a MACD crossover signal?",
        questionType: "MCQ",
        options: [
          "A change in trading volume",
          "A potential change in price momentum or trend direction",
          "The stock has reached its 52-week high",
          "The stock's dividend has been increased"
        ],
        correctAnswer: "A potential change in price momentum or trend direction",
        explanation: "When the MACD line crosses above the signal line, it can suggest bullish momentum. When it crosses below, it can suggest bearish momentum."
      },
      {
        id: 13,
        questionText: "Bollinger Bands widen when market volatility increases.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Bollinger Bands expand during periods of high volatility as price swings become larger, and contract during low volatility when price is consolidating."
      },
      {
        id: 14,
        questionText: "Which of the following best describes the purpose of a moving average?",
        questionType: "MCQ",
        options: [
          "To measure the volume of trades in a given period",
          "To smooth out price data and identify the general trend direction",
          "To calculate the exact future price of a stock",
          "To track a company's earnings over time"
        ],
        correctAnswer: "To smooth out price data and identify the general trend direction",
        explanation: "A moving average smooths short-term price fluctuations to show the overall trend. The 50-day and 200-day moving averages are among the most commonly watched."
      },
      {
        id: 15,
        questionText: "What happens when a stock's 50-day moving average crosses above its 200-day moving average?",
        questionType: "MCQ",
        options: [
          "It is called a death cross and signals bearish momentum",
          "It is called a golden cross and signals potential bullish momentum",
          "It signals the stock has peaked and will reverse",
          "It has no significance to traders"
        ],
        correctAnswer: "It is called a golden cross and signals potential bullish momentum",
        explanation: "A golden cross occurs when the 50-day MA crosses above the 200-day MA. It is considered a bullish signal, suggesting a potential upward trend."
      }
    ]
  },
  ...
  7: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "Overconfidence bias can lead traders to underestimate the risks of their trades.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Overconfident traders often take larger positions than warranted, trade too frequently, and underestimate the probability of losing, leading to poor risk management."
      },
      {
        id: 12,
        questionText: "What is 'anchoring bias' in trading?",
        questionType: "MCQ",
        options: [
          "Selling a stock as soon as it becomes profitable",
          "Relying too heavily on the first piece of information received when making decisions",
          "Copying trades from other investors",
          "Holding on to losing positions indefinitely"
        ],
        correctAnswer: "Relying too heavily on the first piece of information received when making decisions",
        explanation: "Anchoring bias occurs when traders fixate on a reference point, such as the price they paid for a stock, and let it influence decisions even when market conditions have changed."
      },
      {
        id: 13,
        questionText: "A trading journal helps traders identify patterns in their behaviour and improve discipline.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Keeping a trading journal allows traders to review their decisions, identify emotional patterns and systematic mistakes, and develop more consistent, rule-based strategies."
      },
      {
        id: 14,
        questionText: "What does FOMO stand for in trading psychology?",
        questionType: "MCQ",
        options: [
          "Fear Of Market Overreaction",
          "Fear Of Missing Out",
          "Fixed Order Management Option",
          "Forecasting Of Market Opportunity"
        ],
        correctAnswer: "Fear Of Missing Out",
        explanation: "FOMO causes traders to enter positions late out of fear of missing a move, often leading to buying at peaks. It is one of the most common emotional traps in trading."
      },
      {
        id: 15,
        questionText: "Which of the following best describes 'revenge trading'?",
        questionType: "MCQ",
        options: [
          "Copying a competitor's trading strategy",
          "Taking on excessive risk after a loss in an attempt to recover quickly",
          "Selling a stock immediately after it rises 10%",
          "Shorting a stock that another trader recommended"
        ],
        correctAnswer: "Taking on excessive risk after a loss in an attempt to recover quickly",
        explanation: "Revenge trading is an emotional response to a loss where a trader takes impulsive, oversized positions to recover losses quickly. It often leads to further and larger losses."
      }
    ]
  },
  ...
  8: {
    ...
    questions: [
      ...
      {
        id: 11,
        questionText: "Dollar-cost averaging involves investing a fixed amount at regular intervals regardless of the price.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "True",
        explanation: "Dollar-cost averaging reduces the impact of volatility by spreading purchases over time. When prices are low you buy more units, and when prices are high you buy fewer."
      },
      {
        id: 12,
        questionText: "What is a key characteristic of a momentum trading strategy?",
        questionType: "MCQ",
        options: [
          "Buying undervalued stocks and holding them for years",
          "Buying stocks that are trending strongly in one direction and riding the move",
          "Holding equal amounts of stocks and bonds at all times",
          "Avoiding stocks that have risen more than 20% in a year"
        ],
        correctAnswer: "Buying stocks that are trending strongly in one direction and riding the move",
        explanation: "Momentum traders look for stocks already moving strongly in a direction and aim to profit by joining the trend early, exiting before the move reverses."
      },
      {
        id: 13,
        questionText: "Options give the buyer the obligation to buy or sell a stock at a specific price.",
        questionType: "True/False",
        options: ["True", "False"],
        correctAnswer: "False",
        explanation: "Options give the buyer the right, but not the obligation, to buy or sell an asset at a specific price before a certain date. The seller of the option takes on the obligation."
      },
      {
        id: 14,
        questionText: "Which trading style involves holding positions for just a few seconds to minutes to capture very small price movements?",
        questionType: "MCQ",
        options: [
          "Swing trading",
          "Position trading",
        ...
        correctAnswer: "Scalping",
        explanation: "Scalping is a high-frequency trading style where traders open and close positions very quickly, aiming to profit from tiny price changes. It requires discipline and fast execution."
      },
      {
        id: 15,
        questionText: "What is the primary goal of a pairs trading strategy?",
        questionType: "MCQ",
        options: [
          "To hold two stocks in the same sector permanently",
          "To profit from the relative price movement between two historically correlated stocks",
          "To buy one stock and short the entire index it belongs to",
          "To double your position size on every winning trade"
        ],
        correctAnswer: "To profit from the relative price movement between two historically correlated stocks",
        explanation: "Pairs trading involves going long one stock and short another that typically moves with it. When the pair diverges from its historical relationship, traders bet on convergence."
      }
    ]
  }
};